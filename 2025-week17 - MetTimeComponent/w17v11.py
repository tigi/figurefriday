...
def create_country_info_card(country,mode,selected_year, netto, dff):
...
def update_map(selected_country, selected_mode, selected_year):
    ...
    return arrows_and_markers, \
        create_country_info_card(selected_country, selected_mode,selected_year, netto_migration, dff), \
